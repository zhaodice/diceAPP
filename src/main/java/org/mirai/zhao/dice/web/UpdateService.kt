...
object UpdateService {
    ...
    fun autoUpdate(pathFile:File){
        ...
        var newUrl:String?="https://update.trpgbot.com/?RequireUpdate"
        ...
        if(jar_md5!=null&&jar_url!=null){
            ...
            if(local_jar_md5==null|| !jar_md5.equals(local_jar_md5,ignoreCase = true)){//本地文件不存在或md5不同步
                //下载并保存文件
                ...
                if(local_tmp_jar_md5!=null) {
                    if (jar_md5.equals(local_tmp_jar_md5, ignoreCase = true)) {
                        targetFile.delete()
